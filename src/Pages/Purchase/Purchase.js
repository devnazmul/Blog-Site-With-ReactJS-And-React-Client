    ...
    <>
          ...
          <>
                    ...
                    <div className=" w-full py-5 text-left">
                      <h1 className="text-black text-4xl md:text-5xl title-font font-medium mb-5">
                        ...
                        <div className="flex w-full">
                          <p className="text-gray-400 text-sm w-full mt-2">
                            By {post.author}
                          </p>
                          <p className="text-white text-sm w-56 mt-2 bg-yellow-500 rounded-full px-2 py-1 text-center">
                      ...
                      {post.likedUEmail.includes(user.email) ? (
                            ...
                            onClick={() => {
                              !isDisableLike
                                ? user.email
                                  ...
                                  : alert("Please login for place a like 😊")
                                : alert("wait");
                            }}
                          >
                            <BsHeartFill
                              className={`mr-2 text-xl text-red-700`}
                            />{" "}
                            {post.likes}
                          </button>
                          Likes
                        ...
                        <div className="text-xl mt-4 text-gray-400 flex justify-items-center items-center">
                          ...
                          >
                            <BsHeart className={`mr-2 text-xl text-gray-400`} />{" "}
                            {post.likes}
                          </button>
                          Likes
                        </div>
            ...
            {user.email ? (
              <form
                ...
                className="px-5 md:px-10 w-full mt-10 lg:mt-0 flex flex-col justify-start items-start"
              >
                ...
                <div className="flex flex-col w-full">
                  ...
                  {!isDisableComment ? (
                    <input
                      className="cursor-pointer w-full mt-1 bg-bgPrimary text-white py-3 rounded-md"
                      type="submit"
                    />
                  ) : (
                    <input
                      disabled
                      className="cursor-pointer w-full mt-1 bg-gray-100 text-gray-400 py-3 rounded-md"
                      type="submit"
                    />
                  )}
                </div>
      ...
      <div className="text-left text-black purchesCard rounded-lg w-full px-5 md:px-20 flex flex-col relative z-10  shadow-xl">
        ...
        <div>
          {!commentIsLoading ? (
            comments.length === 0 ? (
              <div className="text-red-600 font-medium text-left text-2xl ml-10">
                No comments found!
              </div>
            ) : (
              <>
