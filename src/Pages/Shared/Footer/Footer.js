...
const Footer = () => {
  ...
  return (
    ...
    <div className={`text-gray-600 body-font bg-bgPrimary footer`}>
      <div className="border-t-2">
        <div className="container text-white px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <NavLink to='/' className="flex title-font font-medium items-center md:justify-start justify-center text-black">
            <img className='h-10 w-auto' src="https://i.postimg.cc/L5yr8pmt/coding-language.png" alt="" />
            <span className="ml-3 text-3xl logo text-white">Programming Stack</span>
          </NavLink>
